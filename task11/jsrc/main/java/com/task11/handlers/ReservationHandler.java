...
//                    reservation = Reservation.fromJson(body);
                ...
                try {
                    if (isReservationConflict(reservation, context)) {
        ...
        private boolean isReservationConflict(Reservation newReservation, Context context) {
            ...
            for (Map<String, AttributeValue> item : scanResponse.items()) {
                ...
                if (isOverlapping) {
                    context.getLogger().log("Conflict detected with existing reservation: " + existingStart + " - " + existingEnd);
                    return true;
                }
            }
